...
public class RiskChooseSchoolActivity extends SjmBaseActivity {
    ...
    private void initListView() {
        ...
        lvQuerySchool.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                RiskChooseSchoolActivity.this.setResult(110, intent);
                closeActivity(RiskChooseSchoolActivity.this);
            }
        });
    }
}
