package com.gk.mvp.view.custom.heart;
...
public class PathAnimator extends AbstractPathAnimator {
    ...
    public void start(final View child, final ViewGroup parent) {
        ...
        PathAnimator.FloatAnimation anim = new PathAnimator.FloatAnimation(createPath(mCounter, parent, 2), randomRotation(), parent, child);
